		 ...
		 <div class="about_banner_wrap">
      	...
      	<div class="container">
      		<div class="row single-top">
		  	   <div class="col-md-8">
		  	   	<?php $sql=mysqli_query($conn,"select * from posts");
		  	   	while ($post=mysqli_fetch_assoc($sql)): ?>		  	   	
		  	   	<div class="blog_box">
				 <div class="blog_grid">
				  <h3><a href="blog_single.php"><?php echo($post['title']) ?></a></h3><i class="document"> </i>
				  <a href="blog_single.php"><img src="images/blog_img3.jpg" class="img-responsive" alt=""/></a>
				  <div class="singe_desc">
				    <p><?php echo($post['content']) ?></p>
				     <div class="comments">
		  				<ul class="links">
		  					<li><a href="#"><i class="blog_icon1"> </i><br> <?php echo date("d/m/Y"); ?></a></li>
			...
			<?php endwhile; ?>
				...
				<div class="blog_box">
				 <div class="blog_grid">
				  <h3><a href="blog_single.php">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. </a></h3><i class="document3"> </i>
				    <div class="singe_desc">
