		 ...
		 <div class="about_banner_wrap">
      	    ...
      	    <div class="container">
		       <div class="row about-top">
				 ...
				 <div class="col-md-7 about-left-text">
				   <h2>About Us!</h2>
				   <p>Fitness Developer Team</p>
				   <h4><span class="m_12">UIT-University of Information Technology</span></h4>
				 </div>
                 <div class="clear"></div>	
               </div>
		    </div>
	      ...
	      <div class="container">
	       <div class="about_trainer">
		      <h3 class="m_2">Our Team members</h3>
		      <div class="row about_box">
		      	<a href="#">
		      	<div class="col-md-4">
				  <div class="box1">
				  	<div class="box1_left">
 					  <img src="about/khantthuaung.jpeg" class="img-responsive" alt=""/>				  		
					  <div class="desc1">
						<h3>Khant Thu Aung<br></a>
							<span class="m_text">Front/Back-end </span></h3>
						<p>Fitness-GYM</p>
				...
				<div class="col-md-4">
				  <div class="box2">
				  	<div class="box1_left">
 					  <img src="about/paingthetko.jpg" class="img-responsive" alt=""/>				  		
					  <div class="desc2">
						<h3>Paing Thet Ko<br><span class="m_text">Front/back end</span></h3>
						<p>Fitness-GYM</p>
				...
				<div class="col-md-4">
				  <div class="box1">
				  	<div class="box1_left">
 					  <img src="about/sithusoe.jpg" class="img-responsive" alt=""/>				  		
					  <div class="desc1">
						<h3>SITHU <br>SOE<br><span class="m_text">FRONT/BACK END</span></h3>
						<p>FITNESS-GYM</p>
		     ...
		     <div class="row about_box1">
		      <div class="col-md-4">
				  <div class="box2">
				  	<div class="box1_left">
 					  <img src="about/aungkhantchaw.jpg" class="img-responsive" alt=""/>				  		
					  <div class="desc2">
						<h3>Aung Khant Chaw<br><span class="m_text">FRONT/BACK END</span></h3>
						<p>FITNESS-GYM</p>
				...
				<div class="col-md-4">
				 <div class="box1">
				  	<div class="box1_left">
 					  <img src="about/oakar.jpg" class="img-responsive" alt=""/>				  		
					  <div class="desc1">
						<h3>Oakar <br> Myo<br><span class="m_text">FRONT/BACK END</span></h3>
						<p>FITNESS-GYM</p>
